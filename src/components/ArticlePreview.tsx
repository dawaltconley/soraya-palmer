...
export default function ArticlePreview({
  ...
  return (
    <div className="relative flex flex-col bg-white font-serif text-base">
      <div className="layer-children aspect-video shrink-0">
        <img className="object-cover" src={image.url} alt="" />
      </div>
      <div className="h-full border-y-4 border-gray-100 p-2">
        <H className="font-display text-2xl font-bold">
